...
<form id="form_rs_account_lookup" method="post" action="postback">
    <div class="form-group">
      <div class="row">
        <div class="col-sm-6">
          <select id="search_option" name="search_option" class="form-control margin-bottom-xs" style="text-align:center;">
                  <option value="by_phone_nunber">{_ Search by phone number _}</option>
          </select>
        </div>
        <div class="col-sm-6">
