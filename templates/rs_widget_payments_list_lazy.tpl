<table class="table table-condensed table-centered">
  <thead>
    ...
    <tr id="{{ #mytr }}" style="{% if not m.kazoo[{ui_element_opened element="rs_payments_lists_table_opened"}] %}display: none;{% endif %}">
      <th colspan="3"></th>
    </tr>
  </thead>
</table>
<span id="rs_payments_lists_table_opened"
      style="{% if not m.kazoo[{ui_element_opened element="rs_payments_lists_table_opened"}] %}display: none;{% endif %}"
>
