<div min-height="50%">
  <ul class="nav nav-tabs nav-justified" role="tablist">
    ...
    {% wire id="li_account_web_access"
            type="click"
            action={update target="pannel_div" template="_add_webaccess_list.tpl" account_id=account_id}
    ...
    {% wire id="li_account_sip_access"
            type="click"
            action={update target="pannel_div" template="_add_account_sipaccess_list.tpl" account_id=account_id}
    ...
    {% wire id="li_call_restrictions"
            type="click"
            action={update target="pannel_div" template="_account_restrictions.tpl" account_id=account_id}
            action={remove_class target="li_account_web_access" class="active"}
            action={remove_class target="li_account_sip_access" class="active"}
    ...
    {% wire id="li_calls_allotments"
            type="click"
            action={update target="pannel_div" template="_allotments.tpl" account_id=account_id}
            action={remove_class target="li_account_web_access" class="active"}
            action={remove_class target="li_account_sip_access" class="active"}
            action={remove_class target="li_call_restrictions" class="active"}
