<div class="row" style="padding: 1em; margin-bottom: 1em;">
  ...
  <div class="col-xs-2 col-xs-offset-3">
    ...
    <select id="user_mask_selector" name="selected" class="col-xs-12 form-control margin-bottom-xs selectpicker" title="{_ Mask _}"  data-live-search="true">
      ...
      {% for option in m.kazoo[{kz_list_account_users conference_id=conference_id}] %}
  ...
  {% wire id="cf_details_btn" action={ dialog_open title=_"Account details" template="_account_details.tpl" conference_id=conference_id class="iamclass" width="auto" } %}
  <div class="col-xs-2">
  ...
  {% wire id="rs_account_delete_btn" action={confirm text="Do you really want to delete this account?"
                                     action={postback postback={rs_account_delete conference_id=conference_id} delegate="mod_kazoo"}
                             }
  %}
  <div class="col-xs-2">
...
<div class="pl-10 pr-10 col-md-6">
  ...
  <span id="rs_account_registrations_tpl">
        {% include "rs_account_registrations.tpl" headline=_"Account's current registrations" conference_id=conference_id %}
  </span>
...
<div class="pl-10 pr-10 col-md-6">
  ...
  <span id="rs_allocated_numbers_tpl">
        {% include "rs_allocated_numbers.tpl" headline=_"Account's allocated numbers" conference_id=conference_id %}
  </span>
</div>
