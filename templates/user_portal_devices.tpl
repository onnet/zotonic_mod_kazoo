...
%}
  <span id="arrows_{{ #dtid }}" style="cursor: pointer;">
    ...
    {{ headline }}
    {% button class="btn btn-xs btn-onnet pull-right" text=_"refresh list" action={emit signal={update_user_portal_devices_tpl} } %}
{% endblock %}
...
<div id="user_devices_widget_opened" style="{% if not m.kazoo[{ui_element_opened element="user_devices_widget_opened"}] %}display: none;{% endif %}">
    <div class="text-center p-3">
        {% ilazy class="fa fa-spinner fa-spin fa-3x" action={update target="user_devices_widget_opened"
