...
{% wire id="arrows_"++#id type="click"
        ...
        action={ postback postback={trigger_innoui_widget arg="tasks_widget_opened" } delegate="mod_kazoo" }
%}
  <span id="arrows_{{ #id }}" style="cursor: pointer;">
    <i id="arrow_right_{{ #id }}"
       style="{% if m.kazoo[{ui_element_opened element="tasks_widget_opened"}] %}display: none;{% endif %}" 
