...
<div class="pl-10 pr-10 col-md-6">
  ...
  {% wire action={connect signal={rs_widget_e911_addresses_tpl session_id=m.session.session_id}
...
<div class="pl-10 pr-10 col-md-6">
  ...
  {% wire action={connect signal={update_rs_account_registrations_tpl session_id=m.session.session_id}
