...
%}
  <span id="arrows_{{ #id }}" style="cursor: pointer;">
    <i id="arrow_right_{{ #id }}" style="{% if m.kazoo[{ui_element_opened element="reseller_registrations_widget_opened"}] %}display: none;{% endif %}" 
...
<div id="reseller_registrations_widget_opened" style='{% if not m.kazoo[{ui_element_opened element="reseller_registrations_widget_opened"}] %}display: none;{% endif %}'>
    <div class="text-center p-3">
        {% ilazy class="fa fa-spinner fa-spin fa-3x" action={update target="reseller_registrations_widget_opened"
