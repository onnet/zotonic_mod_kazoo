...
<form id="form_cf_select_voicemail" method="post" action="postback">
    <div class="form-group">
      <div class="row">
        <div class="col-sm-12">
            <select id="voicemail_selector" name="selected" class="form-control margin-bottom-xs" style="text-align:center;" data-live-search="true">
...
<div class="form-group">
  <div class="row">
    <div class="col-sm-12">
      <button id="button_cf_select_voicemail" class="col-xs-12 btn btn-zprimary margin-bottom-xs">{_ Save _}</button>
    </div>
  </div>
</div>
