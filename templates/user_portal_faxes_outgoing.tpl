...
{% wire id="arrow_right_"++#dtid type="click"
        ...
        action={ postback postback={trigger_innoui_widget arg="send_fax_widget_opened" } delegate="inno" }
%}
...
%}
    <span id="arrows_{{ #dtid }}" style="cursor: pointer;">
        <i id="arrow_right_{{ #dtid }}" style="{% if m.inno[{ui_element_opened element="send_fax_widget_opened"}] %}display: none;{% endif %}" 
                                        class="arrowpad fa fa-arrow-circle-right"></i>
        <i id="arrow_down_{{ #dtid }}" style="{% if not m.inno[{ui_element_opened element="send_fax_widget_opened"}] %}display: none;{% endif %}" 
...
<div id="send_fax_widget_opened" style="{% if not m.inno[{ui_element_opened element="send_fax_widget_opened"}] %}display: none;{% endif %}">
