      ...
      <tr id="number_line_{{ forloop.counter }}">
        ...
        <td class="text-center">
           {% wire id="edit_number_"++forloop.counter
                   action={dialog_open title=_"Edit number services for"
                                               ++" "
                                               ++number[1]|pretty_phonenumber
                                       template="_edit_number_services.tpl"
                                       number=number[1]
                                       width="auto"
                          }
           %}
           <i id="edit_number_{{ forloop.counter }}"
        ...
        <td class="text-center">
          ...
          %}
          <i id="delete_number_{{ forloop.counter }}"
             style="cursor: pointer;"
             class="fa fa-trash-o"
             title="{_ Delete _}"></i>
        </td>
