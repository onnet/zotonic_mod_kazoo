      ...
      %}
        <span id="arrows_{{ #rspmcid }}" style="cursor: pointer; padding-left: 0.7em;">
          <i id="arrow_right_{{ #rspmcid }}"
             style="{% if m.kazoo[{ui_element_opened element="rs_per_minute_calls_lists_table_opened"}] %}display: none;{% endif %}" 
             class="arrowpad fa fa-arrow-circle-right"></i>
          <i id="arrow_down_{{ #rspmcid }}"
             style="{% if not m.kazoo[{ui_element_opened element="rs_per_minute_calls_lists_table_opened"}] %}display: none;{% endif %}" 
...
<span id="rs_per_minute_calls_lists_table_opened"
      style="{% if not m.kazoo[{ui_element_opened element="rs_per_minute_calls_lists_table_opened"}] %}display: none;{% endif %}">
