    ...
    <div class="row">
        ...
        <div id="call_forwardnumber" class="col-xs-5">
            {% wire id="edit_call_forwardnumber" type="click" action={ update target="call_forwardnumber" template="_edit_field.tpl" type="device" doc_id=device_id field_name=["call_forward","number"] } %}
            <span>
