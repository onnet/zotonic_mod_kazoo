          ...
          <tr>
            <td style="text-align: center;">
              ...
              {% wire id=cred["id"] ++ "_cccp_active_state_toggler"
                      type="click"
                      action={ postback postback={cccp_field_toggler doc_id=cred["id"] field_name="active" signal_id="update_authorized_cid_table_tpl"}
                                        delegate="mod_kazoo"
                             }
              %}
            </td>
            ...
            <td style="text-align: center;">
              ...
              {% wire id=cred["id"] ++ "_cccp_retain_cid_toggler"
                      type="click"
                      action={ postback postback={cccp_field_toggler doc_id=cred["id"] field_name="retain_cid" signal_id="update_authorized_cid_table_tpl"}
                                        delegate="mod_kazoo"
                             }
              %}
            </td>
