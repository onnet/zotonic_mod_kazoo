            ...
            <td>
              <div class="btn-group pull-right">
                    {% wire id="global_carrier_routing" action={confirm text=_"Do you really want to change this setting?" 
                                                                action={postback postback={global_carrier_routing account_id=account_id} delegate="mod_kazoo"}} %}
                    ...
                    {% if not m.kazoo.kz_current_context_superadmin %}
                        {% wire id="reseller_based_routing" action={confirm text=_"Do you really want to change this setting?" 
                                                                    action={postback postback={reseller_based_routing account_id=account_id} delegate="mod_kazoo"}} %}
                    ...
                    {% wire id="account_based_routing" action={confirm text=_"Do you really want to change this setting?" 
                                                               action={postback postback={account_based_routing account_id=account_id} delegate="mod_kazoo"}} %}
