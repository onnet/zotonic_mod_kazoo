...
<div class="pl-10 pr-10 col-md-6">
  {% wire action={connect signal={update_admin_portal_general_settings_tpl}
  ...
  {% wire action={connect signal={update_admin_portal_groups_list_tpl}
  ...
  {% wire action={connect signal={update_admin_portal_media_list_tpl}
...
<div class="pl-10 pr-10 col-md-6">
  ...
  {% wire action={connect signal={update_admin_portal_menus_list_tpl}
  ...
  {% wire action={connect signal={update_admin_portal_blacklists_tpl}
  ...
  {% wire action={connect signal={update_admin_portal_vms_list_tpl}
  ...
  {% wire action={connect signal={update_admin_portal_lists_tpl}
