...
{% wire id="arrows_"++#dtid type="click"
        ...
        action={postback postback={trigger_innoui_widget arg="onbill_operations_docs_widget_opened"}
                         delegate="mod_kazoo"
               }
%}
  <span id="arrows_{{ #dtid }}" style="cursor: pointer;">
    <i id="arrow_right_{{ #dtid }}"
       style="{% if m.kazoo[{ui_element_opened element="onbill_operations_docs_widget_opened"}] %}
                display: none;
              {% endif %}" 
       class="arrowpad fa fa-arrow-circle-right"></i>
    <i id="arrow_down_{{ #dtid }}"
       style="{% if not m.kazoo[{ui_element_opened element="onbill_operations_docs_widget_opened"}] %}
                display: none;
              {% endif %}" 
       class="arrowpad fa fa-arrow-circle-down"></i>
  </span>
    {{ headline }}
    <input id="docs_month_chosen"
           type="text"
           class="input-small-onnet pull-right"
           name="docs_month_chosen"
           value="{% if docs_month_chosen %}{{ docs_month_chosen }}{% else %}{{ now|sub_month|date: 'm/Y' }}{% endif %}"
...
<div id="onbill_operations_docs_widget_opened"
     style="{% if not m.kazoo[{ui_element_opened element="onbill_operations_docs_widget_opened"}] %}
              display: none;
            {% endif %}">
