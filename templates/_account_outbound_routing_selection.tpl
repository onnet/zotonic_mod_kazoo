            {% with m.kazoo.outbound_routing_strategy as routing %}
              <div class="btn-group pull-right">
                    {% wire id="reseller_based_routing" action={confirm text=_"Do you really want to change this setting?" action={postback postback="reseller_based_routing" delegate="mod_kazoo"}} %}
                    ...
                    {% wire id="account_based_routing" action={confirm text=_"Do you really want to change this setting?" action={postback postback="account_based_routing" delegate="mod_kazoo"}} %}
