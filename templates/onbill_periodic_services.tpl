...
%}
  <span id="arrows_{{ #rdid }}" style="cursor: pointer;">
    <i id="arrow_right_{{ #rdid }}"
       style="{% if m.kazoo[{ui_element_opened element="onbill_periodic_services_widget_opened"}] %}display: none;{% endif %}" 
       class="arrowpad fa fa-arrow-circle-right"></i>
    <i id="arrow_down_{{ #rdid }}"
       style="{% if not m.kazoo[{ui_element_opened element="onbill_periodic_services_widget_opened"}] %}display: none;{% endif %}" 
    ...
    <i id="show_active_periodic_services_toggler"
       class="fa fa-toggle-{% if m.session.show_periodic_fees == "show_all" %}off{% else %}on{% endif %} pointer pull-right"
