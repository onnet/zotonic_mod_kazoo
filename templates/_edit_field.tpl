    <input id="{{ field_name }}_input" name="input_value" style="width:70%; height:20px; text-align:center;" type="text" value="{{ m.kazoo[{kz_doc_field type=type doc_id=doc_id field=field_name}] }}"/>
