      ...
      <th colspan="3">
        ...
        <span id="arrows_{{ #rdid }}" style="cursor: pointer; padding-left: 0.7em;">
          <i id="arrow_right_{{ #rdid }}"
             style="{% if m.kazoo[{ui_element_opened element="rs_related_documents_table_opened"}] %}display: none;{% endif %}" 
             class="arrowpad fa fa-arrow-circle-right"></i>
          <i id="arrow_down_{{ #rdid }}"
             style="{% if not m.kazoo[{ui_element_opened element="rs_related_documents_table_opened"}] %}display: none;{% endif %}" 
...
<span id="rs_related_documents_table_opened"
      style="{% if not m.kazoo[{ui_element_opened element="rs_related_documents_table_opened"}] %}display: none;{% endif %}">
