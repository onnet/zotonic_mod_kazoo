{% wire id="form_cf_select_user" type="submit" postback="cf_select_user" delegate="inno" %}
...
<div class="form-group">
  <div class="row">
    <div class="col-sm-12">
      <button id="button_cf_select_user" class="col-xs-12 btn btn-zprimary margin-bottom-xs">Save</button>
    </div>
  </div>
</div>
