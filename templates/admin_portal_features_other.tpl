...
%}
  <span id="arrows_{{ #dtid }}" style="cursor: pointer;">
    <i id="arrow_right_{{ #dtid }}"
       style="{% if m.kazoo[{ui_element_opened element="ap_features_other_widget_opened"}] %}display: none;{% endif %}" 
       class="arrowpad fa fa-arrow-circle-right"></i>
    <i id="arrow_down_{{ #dtid }}"
       style="{% if not m.kazoo[{ui_element_opened element="ap_features_other_widget_opened"}] %}display: none;{% endif %}" 
...
<div id="ap_features_other_widget_opened"
     style="{% if not m.kazoo[{ui_element_opened element="ap_features_other_widget_opened"}] %}display: none;{% endif %}">
