...
<table id="admin_portal_vms_table" class="table display table-striped table-condensed">
	...
	<tr>
            ...
            <td style="text-align: center;">{% if vmbox_details[1]["owner_id"] %}{{ m.kazoo[{kz_user_doc_by_ownerid owner_id=vmbox_details[1]["owner_id"]}][1]["username"]|truncate:13 }}{% else %}-{% endif %}</td>
