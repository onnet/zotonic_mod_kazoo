  ...
  <div class="col-sm-10">
    ...
    <div class="row">
      ...
      <div id="device_enabled_status" class="col-xs-5">
        {% if device_doc["enabled"] %}
          <span class="zprimary">Enabled</span>{% else %}<span class="zalarm">Disabled</span>
        {% endif %}
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div id="sipusername" class="col-xs-5">
        {% wire id="edit_sipusername"
                type="click"
                action={update target="sipusername"
                               template="_edit_field.tpl"
                               type="device"
                               doc_id=device_id
                               field_name=["sip","username"]
                       }
        %}
        <span>
    ...
    <div class="row">
      ...
      <div class="col-xs-5">
        ...
        <span id="sippassword" style="display:none;">
          {% wire id="edit_sippassword"
                  type="click"
                  action={update target="sippassword"
                                 template="_edit_field.tpl"
                                 type="device"
                                 doc_id=device_id
                                 field_name=["sip","password"]
                         }
          %}
          <span>
    ...
    <div class="row">
      ...
      <div id="device_record_call" class="col-xs-5">
        <i id="toggle_device_record_call"
