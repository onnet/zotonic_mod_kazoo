...
%}
  ...
  {{ headline }}
    ...
    %}
    <input id="new_number_id" class="input input-number-onnet pull-right" type="text" name="new_number_to_add" placeholder="{{ m.config.mod_kazoo.placeholder_phone.value }}" maxlength="18">
{% endblock %}
