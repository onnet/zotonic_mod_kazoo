...
<form id="form_kz_c2call" method="post" action="{{ m.kazoo[{kz_c2call_hyperlink c2call_id=c2call_id}] }}">
    <div class="form-group">
      ...
      <div class="row">
        ...
        <div class="col-sm-5">
          <button class="col-xs-12 btn btn-zprimary margin-bottom-xs c2c_jquery_window_btn">{_ Place test call _}</button>
        </div>
        <div class="col-sm-5">
          <button class="col-xs-12 btn btn-zprimary margin-bottom-xs c2c_jquery_show_btn">{_ Place test call _}</button>
        </div>
      </div>
