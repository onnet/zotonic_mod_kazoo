    ...
    <label class="form-control-onnet margin-bottom-xs">{_ Audio codecs _}:
      <div class="row">
        ...
        <div class="col-sm-2">
          <label for="G722"
                 class="checkbox-inline
                        {% if "G722"|member:device_doc["media"][1]["audio"][1]["codecs"] %}
                          checked
                        {% endif %}"
                 style="width: 100%">
            <input type="checkbox"
        ...
        <div class="col-sm-2">
          <label for="OPUS"
                 class="checkbox-inline
                        {% if "OPUS"|member:device_doc["media"][1]["audio"][1]["codecs"] %}
                          checked
                        {% endif %}"
                 style="width: 100%">
            <input type="checkbox"
    ...
    <label class="form-control-onnet margin-bottom-xs">{_ Video codecs _}:
      <div class="row">
        <div class="col-sm-2 col-sm-offset-2">
          <label for="VP8"
                 class="checkbox-inline
                        {% if "VP8"|member:device_doc["media"][1]["video"][1]["codecs"] %}
                          checked
                        {% endif %}"
                 style="width: 100%">
            <input type="checkbox"
        ...
        <div class="col-sm-2">
          <label for="H264"
                 class="checkbox-inline
                        {% if "H264"|member:device_doc["media"][1]["video"][1]["codecs"] %}
                          checked
                        {% endif %}"
                 style="width: 100%">
            <input type="checkbox"
        ...
        <div class="col-sm-2">
          <label for="H263"
                 class="checkbox-inline
                        {% if "H263"|member:device_doc["media"][1]["video"][1]["codecs"] %}
                          checked
                        {% endif %}"
                 style="width: 100%">
            <input type="checkbox"
        ...
        <div class="col-sm-2">
          <label for="H261"
                 class="checkbox-inline
                        {% if "H261"|member:device_doc["media"][1]["video"][1]["codecs"] %}
                          checked
                        {% endif %}"
                 style="width: 100%">
            <input type="checkbox"
