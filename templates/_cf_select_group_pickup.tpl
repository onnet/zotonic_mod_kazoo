{% wire id="form_cf_select_group_pickup"
        type="submit"
        postback="cf_select_group_pickup"
        delegate="mod_kazoo"
%}
<form id="form_cf_select_group_pickup" method="post" action="postback">
  <div class="form-group">
    <div class="row">
      <div class="col-sm-6">
        {% wire id="selected_type"
                type="change"
                action={update target="choice_input_div"
...
<div class="form-group">
  <div class="row">
    <div class="col-sm-12">
      <button id="button_cf_select_group_pickup"
...
{% wire id="button_cf_select_group_pickup"
