...
<div class="pl-10 pr-10 col-md-6">
  ...
  {% wire action={connect signal={update_admin_portal_crmintegra_list_tpl}
                          action={update target="admin_portal_crmintegra_list_tpl" template="admin_portal_crmintegra_list.tpl" headline=_"CRM Integrations"}
                 }
  %}
