...
{% wire id="arrows_"++#dtid type="click"
        ...
        action={postback postback={trigger_innoui_widget arg="vmboxes_list_widget_opened"}
                         delegate="mod_kazoo"
               }
%}
  <span id="arrows_{{ #dtid }}" style="cursor: pointer;">
    <i id="arrow_right_{{ #dtid }}"
       style="{% if m.kazoo[{ui_element_opened element="vmboxes_list_widget_opened"}] %}
                display: none;
              {% endif %}"
  ...
  {% button class="btn btn-xs btn-onnet pull-right"
            text=_"purge messages"
            action={dialog_open title=_"Clean up Voicemail Boxes"
...
<div id="vmboxes_list_widget_opened"
  ...
  <div class="text-center p-3">
    {% ilazy class="fa fa-spinner fa-spin fa-3x"
             action={update target="vmboxes_list_widget_opened"
