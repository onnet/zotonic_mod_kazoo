...
<a id="play_{{ #this_recording }}" onclick='$("#audio_{{ #this_recording }}").trigger("play");
                                        $("#play_{{ #this_recording }}").toggle();
                                        $("#pause_{{ #this_recording }}").toggle();'>
   <i style="cursor: pointer;" class="fa fa-play" title="{_ Play _}"></i>
</a>
<a id="pause_{{ #this_recording }}" style="display: none;" onclick='$("#audio_{{ #this_recording }}").trigger("pause");
                                                                $("#play_{{ #this_recording }}").toggle();
                                                                $("#pause_{{ #this_recording }}").toggle();'>
   <i style="cursor: pointer;" class="fa fa-pause" title="{_ Pause _}"></i>
</a>
<a  style="cursor: pointer;" id="stop_{{ #this_recording }}" onclick='$("#audio_{{ #this_recording }}").trigger("pause");
