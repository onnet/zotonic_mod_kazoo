{% wire id="form_rs_kz_customer_update"
        type="submit"
        postback="rs_kz_customer_update"
        delegate="mod_kazoo"
%}
      ...
      <div class="col-sm-12">
        <label class="form-control-onnet margin-bottom-xs">{_ Text body _}:
          <textarea name="text_body"
                    style="height: 200px; width: 100%">{{ m.kazoo[{kz_notification_template notification_id="customer_update" context_type="text/plain"}] }}</textarea>
        </label>
      </div>
    </div>
  </div>
