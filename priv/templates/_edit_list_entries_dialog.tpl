{% wire id="form_account_list_entries"
        type="submit"
        postback="account_list_entries"
        delegate="mod_kazoo"
%}
    ...
    <div class="row">
      <div class="col-sm-3">
        <input type="text"
               ...
               id="list_entry_number"
               name="list_entry_number"
               placeholder="{_ Enter number here _}"
               value="">
      </div>
      <div class="col-sm-6">
        <input type="text"
               class="form-control margin-bottom-xs"
               id="list_entry_displayname"
               name="list_entry_displayname"
               placeholder="{_ Enter description here _}"
               value="">
      </div>
      <div class="col-sm-3">
        {% button text=_"Add entry"
                  class="col-xs-12 btn btn-zprimary margin-bottom-xs"
                  action={form_reset target="form_account_list_entries"}
                  action={submit target="form_account_list_entries"}
        %}
      </div>
    </div>
  </div>
