...
%}
  <span id="arrows_calls_details_widget" style="cursor: pointer;">
    <i id="arrow_right_calls_details_widget"
       {% if cdr_id %}
         style="display: none;"
       {% endif %}
       class="arrowpad fa fa-arrow-circle-right"></i>
    <i id="arrow_down_calls_details_widget"
       {% if not cdr_id %}
         style="display: none;"
       {% endif %}
...
<div id="ap_calls_details_widget_opened"
     {% if not cdr_id %}
       style="display: none;"
     {% endif %}>
  <div class="text-center p-3">
    {% ilazy class="fa fa-spinner fa-spin fa-3x"
             action={update target="ap_calls_details_widget_opened"
