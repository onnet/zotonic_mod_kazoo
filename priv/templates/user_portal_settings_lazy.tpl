{% if m.kazoo[{ui_element_opened element="user_settings_widget_opened"}] %}
  ...
  <form  id="user_settings_form_form" method="post" action="postback">
    ...
    <div id="call-forward-data"
         style="{% if m.kazoo[{kz_user_doc_field field1="call_forward" field2="enabled"}] %}
                  display: block;
                {% else %}
                  display: none;
                {% endif %}">
      <div class="form-inline">
        ...
        <input id="ring-number-txt"
               name="ring-number-txt"
               type="text" 
      ...
      <div class="form-inline">
        ...
        {% if m.kazoo[{kz_user_doc_field field1="call_forward" field2="substitute"}] %}
          <input class="checkbox"
                 id="ring-device-checkbox"
                 name="ring-device-checkbox"
                 type="checkbox"/>
        {% else %}
          <input class="checkbox"
                 id="ring-device-checkbox"
      ...
      <div class="form-inline">
        ...
        {% if m.kazoo[{kz_user_doc_field field1="call_forward" field2="keep_caller_id"}] %}
           <input id="call_forward_keep_caller_id"
                  class="checkbox"
                  name="call_forward_keep_caller_id"
                  type="checkbox"
                  checked="checked"/>
        {% else %}
           <input id="call_forward_keep_caller_id"
    ...
    <div class="form-inline" style="padding-left: 1em; padding-top: 1em;">
      ...
      {% wire id="vm-to-email-checkbox"
              type="click"
              action={toggle target="vm-to-email-input"}
      %}
      <input id="vm-to-email-checkbox"
             class="checkbox"
             name="vm-to-email-checkbox"
             type="checkbox"
             {% if m.kazoo[{kz_user_doc_field field1="vm_to_email_enabled"}] %}
               checked="checked"
             {% endif %} />
    </div>
    <div id="vm-to-email-input"
         class="form-inline"
      ...
      <i class="fa fa-info-circle pointer zprimary"
