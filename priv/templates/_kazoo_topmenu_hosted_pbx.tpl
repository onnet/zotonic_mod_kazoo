<ul class="nav navbar-nav">
  <li class="dropdown">
   <a href="#"
      ...
      data-toggle="dropdown">{_ Hosted PBX _} <b class="caret"></b></a>
     <ul class="dropdown-menu">
         ...
         {% if m.kazoo.is_kazoo_account_admin %}
           ...
           <li><a href="/account_call_recordings">{_ Call recordings _}</a>
...
%}
  <ul class="nav navbar-nav navbar-right hidden-xs" style="margin-right: 0;">
    {% wire id="rs_demask"
            action={postback postback="rs_account_demask"
                             delegate="mod_kazoo"
                   }
    %}
    <li id="rs_demask">
