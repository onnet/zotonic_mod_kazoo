...
resource_exists(ReqData, Context) ->
    DocId = z_context:get_q("id", Context),
    {kazoo_util:kz_incoming_fax_attachment_pdf(DocId, Context) =/= <<>>, ReqData, Context}.
...
provide_content(ReqData, Context) ->
    ...
    case z_context:get(body, Context) of
        undefined ->
            Data = z_convert:to_binary(kazoo_util:kz_incoming_fax_attachment_pdf(DocId, Context)),
